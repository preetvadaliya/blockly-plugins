 ...
 * @private
 */
Blockly.Workspace.prototype.flydown_ =
  Blockly.Workspace.prototype.flydown_ || null;

Blockly.Workspace.prototype.getFlydown =
  Blockly.Workspace.prototype.getFlydown ||
  function () {
 ...
 */
Blockly.Workspace.prototype.getProcedureDatabase =
  Blockly.Workspace.prototype.getProcedureDatabase ||
  function () {
 ...
 */
Blockly.Workspace.prototype.getTopWorkspace =
  Blockly.Workspace.prototype.getTopWorkspace ||
  function () {
    let parent = this;
...
Blockly.Workspace.prototype.getWarningHandler =
  Blockly.Workspace.prototype.getWarningHandler ||
  function () {
 ...
 * @private
 */
Blockly.WorkspaceSvg.prototype.flydown_ =
  Blockly.WorkspaceSvg.prototype.flydown_ || null;

Blockly.WorkspaceSvg.prototype.getFlydown =
  Blockly.WorkspaceSvg.prototype.getFlydown ||
  function () {
    return this.flydown_;
  };
 ...
 * @return {!Blockly.ProcedureDatabase}
 */
Blockly.WorkspaceSvg.prototype.getProcedureDatabase =
  Blockly.WorkspaceSvg.prototype.getProcedureDatabase ||
  function () {
    if (!this.procedureDb_) {
      this.procedureDb_ = new ProcedureDatabase(this);
 ...
 */
Blockly.WorkspaceSvg.prototype.getTopWorkspace =
  Blockly.WorkspaceSvg.prototype.getTopWorkspace ||
  function () {
    let parent = this;
    while (parent.targetWorkspace) {
...
Blockly.WorkspaceSvg.prototype.getWarningHandler =
  Blockly.WorkspaceSvg.prototype.getWarningHandler ||
  function () {
