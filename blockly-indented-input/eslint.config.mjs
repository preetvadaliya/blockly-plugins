...
export default [
...

  {
    ...
    rules: {
      ...
      // Blockly's file headers put the licence on its own lines:
      //
      //   @license
      //   Copyright <year> <holder>
      //   SPDX-License-Identifier: Apache-2.0
      //
      // so @license carries no inline value for this rule to validate. This
      // one is about the header format, not about types, so it stays off.
